<footer class="px-16 py-8 flex flex-col gap-8">
    <nav class="flex">
        <div class="lg:w-1/4">
            <h6>Quick Links</h6>
            <ul>
    ...
    <div class="flex gap-4">
        ...
        <div class="links w-1/4">
            <div>
                <h6>Follow Us</h6>
                <div class="flex px-4">
                    <div class="w-1/3"><a href="#"></a></div>
                    <div class="w-1/3"><a href="#"></a></div>
                    <div class="w-1/3"><a href="#"></a></div>
                </div>
            </div>
            <div class="team">
                <p class="text-sm px-4">Powered by <span class="text-base">FOP</span></p>
            </div>
        </div>
    </div>
</footer>