...
<div class="custom-content-bg bg-[url('assets/img/project/bg-img-02.jpg')]">
    <div class="lg:hidden custom-dropdown">
        ...
        <div id="myDropdown" class="custom-dd-content">
            <a href="<?= APP_ROOT . "projects?p=1&filter=all" ?>" <?php if ($_GET['filter'] == "all") : ?>class="m-active"<?php endif ?>><li>Show All</li></a>
            <a href="<?= APP_ROOT . "projects?p=1&filter=subdivision" ?>" <?php if ($_GET['filter'] == "subdivision") : ?>class="m-active"<?php endif ?>><li>Subdivision</li></a>
            <a href="<?= APP_ROOT . "projects?p=1&filter=business bldg." ?> " <?php if ($_GET['filter'] == "business bldg.") : ?>class="m-active"<?php endif ?>><li>Business Bldg.</li></a>
            <a href="<?= APP_ROOT . "projects?p=1&filter=hospital" ?> " <?php if ($_GET['filter'] == "hospital") : ?>class="m-active"<?php endif ?>><li>Hospital</li></a>
            <a href="<?= APP_ROOT . "projects?p=1&filter=malls" ?> " <?php if ($_GET['filter'] == "malls") : ?>class="m-active"<?php endif ?>><li>Malls</li></a>
            <a href="<?= APP_ROOT . "projects?p=1&filter=industrial" ?> " <?php if ($_GET['filter'] == "industrial") : ?>class="m-active"<?php endif ?>><li>Industrial</li></a>
            <a href="<?= APP_ROOT . "projects?p=1&filter=agricultural" ?> " <?php if ($_GET['filter'] == "agricultural") : ?>class="m-active"<?php endif ?>><li>Agricultural</li></a>
        </div>
    </div>
