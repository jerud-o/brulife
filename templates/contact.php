...
<?php if (isset($sentStatus)) : ?>
  <div class="sent text-white absolute left-1/2 -translate-x-1/2 p-4 md:left-0 md:-translate-x-0 md:text-gray-700"><?= $sentStatus ?><svg xmlns="http://www.w3.org/2000/svg" class="text-white md:text-green-600 inline mx-1 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
<div class="mt-0 py-20 bg-primary-green p-4 px-20 flex flex-col gap-4 md:flex-row md:my-14 max-w-screen-lg mx-auto">
  <div class="basis-1/2">
    ...
    <div class="flex mt-6">
      ...
      <p class="ml-4 text-white">+632 8801 5025 <br><a class="w-full" href="#">http://brulifegreatholdings.com</a></p>
