    ...
    <div class="custom-content-wrapper">
        ...
        <div class="custom-content">
            ...
            <div class="custom-text-content">
                <h1>About Us</h1>
                <p>BRU Digital Television is a broadcasting and media corporation duly registered to SEC, airing news, business, lifestyles and entertainment shows in 9 social media platforms anchored by professionals and business executives.</p>
            </div>
        </div>
        <button class="custom-button-style custom-button" href="https://www.youtube.com/channel/UCfZ4kY2ve7yy7u0v5hCOOwA" target="_blank">Visit Youtube Channel</button>
    </div>
